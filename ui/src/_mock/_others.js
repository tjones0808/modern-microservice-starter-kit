...
export const _homePlans = [
  {
    license: 'Free Tier',
    commons: [
      'Permanent Storage of Essential Documents',
      'Access to Basic Vault Features',
      'Community Support',
    ],
    options: [
      ...
      'Access to AI Chatbot for Navigation',
    ],
    icons: [
      '/assets/icons/platforms/ic_js.svg',
      // '/assets/icons/platforms/ic_ts.svg',
      // '/assets/icons/platforms/ic_figma.svg',
      // '/assets/icons/heredity/ic_storage.svg',
      // '/assets/icons/heredity/ic_memorial.svg',
      // '/assets/icons/heredity/ic_security.svg',
      // '/assets/icons/heredity/ic_ai_chatbot.svg',
    ],
  },
  {
    license: 'Paid Tier',
    commons: [
      ...
      'Access to Advanced Vault Features',
    ],
    options: [
      'Private Memorial Pages',
      'Advanced Gamification Features',
      'Enhanced Security Encryption',
      'Personalized AI Chatbot Assistance',
    ],
    icons: [
      '/assets/icons/platforms/ic_js.svg',
      '/assets/icons/platforms/ic_ts.svg',
      // '/assets/icons/platforms/ic_figma.svg',
      // '/assets/icons/heredity/ic_enhanced_storage.svg',
      // '/assets/icons/heredity/ic_customer_support.svg',
      // '/assets/icons/heredity/ic_advanced_security.svg',
      // '/assets/icons/heredity/ic_personalized_ai.svg',
    ],
  },
  {
    license: 'Paid Tier+',
    commons: [
      ...
      'Full Access to All Vault and Memorial Features',
    ],
    options: [
      'Custom Memorial Pages Design',
      'Premium Gamification Features',
      'Enterprise-Level Security Encryption',
      'Advanced AI Chatbot Interactions',
    ],
    icons: [
      // '/assets/icons/heredity/ic_unlimited_storage.svg',
      // '/assets/icons/heredity/ic_247_support.svg',
      // '/assets/icons/heredity/ic_enterprise_security.svg',
      // '/assets/icons/heredity/ic_advanced_ai_chatbot.svg',
      '/assets/icons/platforms/ic_js.svg',
      '/assets/icons/platforms/ic_ts.svg',
      '/assets/icons/platforms/ic_figma.svg',
    ],
